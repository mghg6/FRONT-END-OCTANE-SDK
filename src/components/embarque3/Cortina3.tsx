    ...
    useEffect(() => {
        ...
        connection.start()
            .then(() => {
                ...
                connection.invoke("JoinGroup", "Embarque-Carril-3")
                    .then(() => console.log("Unido al grupo Embarque-Carril-3"))
        ...
        return () => {
            if (connection.state === signalR.HubConnectionState.Connected) {
                connection.invoke("LeaveGroup", "Embarque-Carril-3")
                    .then(() => {
                        console.log("Desconectado del grupo Embarque-Carril-3");
        ...
        <div className="outer-container">
            <div className="product-list-container">
                <div className="entry-title">
                    <h2>Salidas Cortina 3</h2> {/* Cambiado para Salida */}
                </div>
